...
/**
 * @typedef {Object} SceneWrapper
 * @property {Scene} scene
 * @property {function(Mesh): void} addMesh
 * @property {function(Mesh): void} removeMesh
 * @property {function(function(number): void): void} addPerFrame
 */

/**
 * @param {HTMLElement} holderElement
 * @param {Camera} cameraObject
 * @returns {SceneWrapper}
 */
